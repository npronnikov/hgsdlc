...
const RULES = [
  ...
  { re: /Referenced rules are deprecated: (.+)/i, msg: (_, refs) => `Referenced rules are deprecated: ${refs}` },
  { re: /Referenced skills are deprecated: (.+)/i, msg: (_, refs) => `Referenced skills are deprecated: ${refs}` },
  ...
  { re: /Flow is deprecated and cannot be launched: (.+)/i, msg: (_, ref) => `Flow is deprecated and cannot be launched: ${ref}` },
